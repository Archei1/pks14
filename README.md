...
## ZIP файл в котором: APK приложения, икноки (которые не генерирует Flutter), снимки попытки залить приложение на Рустор, снимок основной причины отказа модераторов
[Проект Flutter.zip](https://github.com/user-attachments/files/18233258/Flutter.zip)
